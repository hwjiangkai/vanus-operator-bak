...
func NoWarningsCondition(resources []runtime.Object, oldCondition *VanusClusterCondition) VanusClusterCondition {
	condition := newVanusClusterCondition(NoWarnings)
	if oldCondition != nil {
